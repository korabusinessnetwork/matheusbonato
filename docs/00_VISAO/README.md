...
Negócio pequeno no Brasil vende no WhatsApp e no Instagram, e quando finalmente
...
- **DIY / template**: barato e imediato, mas trava exatamente quando o negócio cresce.

## North star

**Pedidos qualificados chegando no WhatsApp do dono.** Não visitas, não curtidas,
não "site bonito": pedido com contexto, prazo e orçamento já escritos.
...
- Não é agência com equipe, atendimento 24h ou SLA corporativo.
- Não é marketplace de template.
- Não é serviço de tráfego pago, social media ou branding completo.
- Não é SaaS: é serviço de alto ticket, vendido de forma consultiva.

## Métrica que importa (Fase 1)
...
Uma página, uma conversão. Entram: hero, problema, trajetória, método, cardápio
de pacotes, provas, garantia, dúvidas, formulário de pedido, rodapé.
Ficam fora: blog, portfólio detalhado, área de cliente, `/obrigado`, analytics.
